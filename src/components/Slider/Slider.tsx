...
const Slider: React.FC = () => (
  <Carousel arrows infinite={true}>
    ...
    <div className="container">
      <h2>Our Mission</h2>
      <p>
        Kongwell's mission is to create a sustainable and reliable energy future
        by optimizing supply chains and managing market risks. We are committed
        to delivering value to our partners and clients through innovation and
        expertise. Our goal is to ensure energy accessibility while fostering
        long-term, reliable relationships.
      </p>
    </div>
    <div className="container">
      <h2>Our Vision</h2>
      <p>
        ...
        efficient, and driven by innovation. Kongwell aims to be a leader in the
        energy trading industry, consistently pushing the boundaries of
